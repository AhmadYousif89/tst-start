...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:text-blue-400 hover:border-blue-400 hover:[&svg]:text-blue-400 [a]:hover:bg-primary/80",
        outline:
          "border-border bg-muted/90 dark:hover:bg-muted/80 bg-muted-foreground text-primary-foreground shadow-xs hover:bg-muted-foreground/90",
        secondary:
        ...
        destructive:
          "bg-destructive text-primary-foreground hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive focus-visible:border-transparent focus-visible:ring-offset-2",
      ...
      size: {
        ...
        sm: "h-8 gap-1 rounded-[min(var(--radius-md),12px)] px-2.5 in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5",
