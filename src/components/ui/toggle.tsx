  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border text-muted-foreground hover:border-blue-600 hover:text-blue-600 bg-transparent shadow-xs dark:hover:text-blue-400 dark:hover:border-blue-400 data-[state=on]:hover:border-transparent!",
      },
      size: {
