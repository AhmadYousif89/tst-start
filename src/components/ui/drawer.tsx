...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "bg-background/50 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-50",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background text-5 fixed z-50 flex h-auto flex-col gap-2 outline-none",
